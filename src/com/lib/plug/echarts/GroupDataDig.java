...
public class GroupDataDig extends DBSQL {
	static GroupDataDig source;

	public static GroupDataDig getInstance() {
		if (source == null) {
			source = new GroupDataDig();
		}
	...
	public void Operation(Map<String, Object> o) {
		...
		if (o.get("query").toString().length() < 2) {
			echo("query长度"+o.get("query").toString()+"结束;");
			return;
		}
